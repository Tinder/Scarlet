...
class ObservableTest {
    ...
    fun send_givenConnectionIsEstablished_shouldBeReceivedByTheServer() {
        ...
        serverEventObserver.awaitValues(
            ...
            any<Event.OnMessageReceived>().containingText(textMessage1),
            any<Event.OnMessageReceived>().containingText(textMessage2),
            any<Event.OnMessageReceived>().containingBytes(bytesMessage1),
            any<Event.OnMessageReceived>().containingBytes(bytesMessage2)
        )
    ...
    private fun createServer(): Service {
        ...
        val scarlet = Scarlet.Builder()
            ...
            .addStreamAdapterFactory(RxJavaStreamAdapterFactory())
            .build()
